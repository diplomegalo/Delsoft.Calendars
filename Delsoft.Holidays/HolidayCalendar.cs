...
namespace Delsoft.Holidays.Calendars
{
    public abstract class HolidayCalendar
    {
        ...
        public abstract IEnumerable<Models.Holiday> GetAll();
        ...
        where THolidayCalendar : HolidayCalendar<THolidayCalendar>, new()
    {
        ...
        public IEnumerable<Models.Holiday> Get(params Func<THolidayCalendar, Models.Holiday>[] args) => args.Select(func => func.Invoke((THolidayCalendar)this));
    }
}